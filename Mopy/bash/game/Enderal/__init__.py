...
class EnderalGameInfo(GameInfo):
    displayName = u'Enderal'
    fsName = u'Enderal'
    altName = u'Wrye Smash'
    defaultIniFile = u'enderal_default.ini'
    exe = u'TESV.exe'
    masterFiles = [u'Skyrim.esm', u'Update.esm','Enderal - Forgotten Stories.esm']
    ...
    def init(cls):
        ...
        from .records import MreHeader, MreLvli, MreLvln, MreLvsp
        # ---------------------------------------------------------------------
        ...
        brec.MreRecord.type_class = dict((x.classType,x) for x in (
            #--Always present
            MreHeader, MreLvli, MreLvln, MreLvsp,
